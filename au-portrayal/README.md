# Conformance class: Portrayal, Administrative Units
...
| ------------- | ----------------- | ---------------- | ---------- |
| [Technical Guidance for the implementation of INSPIRE View Services](#ref_TG_VS) | [Layer metadata](https://github.com/inspire-eu-validation/view-service/tree/master/layer-metadata) | Capabilities document |  `service type`  |
